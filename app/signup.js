...
const Login = () => {
  ...
  return (
    ...
    <Image source={require("../assets/cinemskuy.png")}/>
        ...
        <InputField type="text"  placeholder="New Username"
        borderColor="black" borderWidth={3} borderRadius={20} paddingLeft={14}/>
        </Input>
        <Input width={220} borderColor="transparent">
        <InputField type="password"  placeholder="Insert Password"
        borderColor="black" borderWidth={3} borderRadius={20} paddingLeft={14}/>
        </Input>
        <Input width={220} borderColor="transparent">
        <InputField type="password"  placeholder="Re-type Password"
        borderColor="black" borderWidth={3} borderRadius={20} paddingLeft={14}/>
        </Input>
        <Input width={220} borderColor="transparent">
        ...
        <View mt={50}>
        <Text mb={8} textAlign="center" fontWeight="bold" color="black">Already have account ?</Text>
        <Button width={220} borderRadius={20} bg="$yellow300" onPress={handlePress}>
